...
.LVL8:
	...
	bld r24,0	 ;  D.2072
.LVL9:
	out 0x2d,r24	 ;  MEM[(volatile uint8_t *)77B], D.2072
 ;  SUCC: EXIT [100.0%] 
	ret
	.cfi_endproc
.LFE17:
...
.L__stack_usage = 0
	 ;  ../mcu/spi.c:66
	.loc 1 66 0
	out 0x2a,__zero_reg__	 ;  MEM[(volatile uint8_t *)74B],
	 ;  ../mcu/spi.c:68
	.loc 1 68 0
	ldi r24,lo8(-1)	 ;  tmp47,
	out 0x2b,r24	 ;  MEM[(volatile uint8_t *)75B], tmp47
	 ;  ../mcu/spi.c:70
	.loc 1 70 0
	ldi r20,lo8(-1)	 ; ,
...
.L8:
 ...
 ;  PRED: 3 [9.0%]  (FALLTHRU,CAN_FALLTHRU,LOOP_EXIT)
	 ;  ../mcu/spi.c:103
	.loc 1 103 0
	in r24,0x2e	 ;  D.2085, MEM[(volatile uint8_t *)78B]
 ;  SUCC: EXIT [100.0%] 
	 ;  ../mcu/spi.c:104
	.loc 1 104 0
	ret
...
.L11:
 ...
 ;  PRED: 3 [9.0%]  (FALLTHRU,CAN_FALLTHRU,LOOP_EXIT)
	 ;  ../mcu/spi.c:114
	.loc 1 114 0
	in r24,0x2e	 ;  D.2090, MEM[(volatile uint8_t *)78B]
.LVL19:
 ;  SUCC: EXIT [100.0%] 
	 ;  ../mcu/spi.c:115
	.loc 1 115 0
...
.L__stack_usage = 8
	 ;  ../mcu/spi.c:126
	.loc 1 126 0
	in r24,0x2a	 ;  spi_in_idx, MEM[(volatile uint8_t *)74B]    1
.LVL20:
	 ;  ../mcu/spi.c:127
	.loc 1 127 0
	in r25,0x2e	 ;  D.2094, MEM[(volatile uint8_t *)78B]        1
	mov r30,r24	 ;  D.2093, spi_in_idx                          1
	ldi r31,0	 ;  D.2093                                      1
	subi r30,lo8(-(spi_in_buf))	 ;  tmp56,                      1
	sbci r31,hi8(-(spi_in_buf))	 ;  tmp56,                      1
	st Z,r25	 ;  spi_in_buf, D.2094                          2
	 ;  ../mcu/spi.c:128
	.loc 1 128 0
	subi r24,lo8(-(1))	 ;  D.2094,                             1
.LVL21:
	ldi r25,lo8(1)	 ;  D.2094,                                 1
	cpi r24,lo8(-1)	 ;  D.2094,                                 1
...
.L14:
	add r25,r24	 ;  D.2094, D.2094                              1
	out 0x2a,r25	 ;  MEM[(volatile uint8_t *)74B], D.2094    1
	 ;  ../mcu/spi.c:130
	.loc 1 130 0
	in r24,0x2b	 ;  spi_out_idx, MEM[(volatile uint8_t *)75B]   1
.LVL22:
	 ;  ../mcu/spi.c:131
	.loc 1 131 0
	cpi r24,lo8(-1)	 ;  spi_out_idx,                            1
 ...
 ;  PRED: 4 [62.2%]  (FALLTHRU,CAN_FALLTHRU)
	 ;  ../mcu/spi.c:132
	.loc 1 132 0
	mov r30,r24	 ;  D.2093, spi_out_idx                         1
	ldi r31,0	 ;  D.2093                                      1
	subi r30,lo8(-(spi_out_buf))	 ;  tmp63,                  1
	sbci r31,hi8(-(spi_out_buf))	 ;  tmp63,                  1
	ld r25,Z	 ;  D.2094, spi_out_buf                         2
	out 0x2e,r25	 ;  MEM[(volatile uint8_t *)78B], D.2094    1
	 ;  ../mcu/spi.c:133
	.loc 1 133 0
	subi r24,lo8(-(-1))	 ;  D.2094,                             1
.LVL23:
...
.L16:
	add r25,r24	 ;  D.2094, D.2094                              1
	out 0x2b,r25	 ;  MEM[(volatile uint8_t *)75B], D.2094    1
...
.L15:
 ;  SUCC: 9 [100.0%]  (FALLTHRU,CAN_FALLTHRU)
	 ;  ../mcu/spi.c:135
	.loc 1 135 0
	out 0x2e,r24	 ;  MEM[(volatile uint8_t *)78B], spi_out_idx
.LVL25:
...
.Ldebug_info0:
	.long	0x482	 ;  Length of Compilation Unit Info
	...
	.long	0x45c	 ;  DW_AT_abstract_origin
	...
	.byte	0x1	 ;  DW_AT_GNU_all_call_sites
	.long	0x3a7	 ;  DW_AT_sibling
	.uleb128 0x10	 ;  (DIE (0x388) DW_TAG_variable)
	.long	.LASF2063	 ;  DW_AT_name: "spi_in_idx"
	.byte	0x1	 ;  DW_AT_decl_file (../mcu/spi.c)
	.byte	0x7e	 ;  DW_AT_decl_line
	.long	0x30	 ;  DW_AT_type
	.long	.LLST7	 ;  DW_AT_location
	.uleb128 0x10	 ;  (DIE (0x397) DW_TAG_variable)
	.long	.LASF2064	 ;  DW_AT_name: "spi_out_idx"
	.byte	0x1	 ;  DW_AT_decl_file (../mcu/spi.c)
	.byte	0x82	 ;  DW_AT_decl_line
	.long	0x30	 ;  DW_AT_type
	.long	.LLST8	 ;  DW_AT_location
	.byte	0	 ;  end of children of DIE 0x36e
	.uleb128 0x19	 ;  (DIE (0x3a7) DW_TAG_variable)
	.long	.LASF2065	 ;  DW_AT_name: "tickCount"
	.byte	0x4	 ;  DW_AT_decl_file (include/timer.h)
	.byte	0x5e	 ;  DW_AT_decl_line
	.long	0x3b4	 ;  DW_AT_type
	.byte	0x1	 ;  DW_AT_external
	.byte	0x1	 ;  DW_AT_declaration
	.uleb128 0xb	 ;  (DIE (0x3b4) DW_TAG_volatile_type)
	.long	0x111	 ;  DW_AT_type
	.uleb128 0x19	 ;  (DIE (0x3b9) DW_TAG_variable)
	.long	.LASF2066	 ;  DW_AT_name: "os_thread_running"
	.byte	0x5	 ;  DW_AT_decl_file (include/os_thread.h)
	.byte	0x69	 ;  DW_AT_decl_line
	.long	0x3c6	 ;  DW_AT_type
	.byte	0x1	 ;  DW_AT_external
	.byte	0x1	 ;  DW_AT_declaration
	.uleb128 0xd	 ;  (DIE (0x3c6) DW_TAG_pointer_type)
	.byte	0x2	 ;  DW_AT_byte_size
	.long	0x18c	 ;  DW_AT_type
	.uleb128 0x19	 ;  (DIE (0x3cc) DW_TAG_variable)
	.long	.LASF2067	 ;  DW_AT_name: "dummy_signal"
	.byte	0x5	 ;  DW_AT_decl_file (include/os_thread.h)
	.byte	0x6c	 ;  DW_AT_decl_line
	.long	0x138	 ;  DW_AT_type
	.byte	0x1	 ;  DW_AT_external
	.byte	0x1	 ;  DW_AT_declaration
	.uleb128 0x1a	 ;  (DIE (0x3d9) DW_TAG_array_type)
	.long	0x30	 ;  DW_AT_type
	.long	0x3e9	 ;  DW_AT_sibling
	.uleb128 0x1b	 ;  (DIE (0x3e2) DW_TAG_subrange_type)
	.long	0x3e9	 ;  DW_AT_type
	.byte	0xfe	 ;  DW_AT_upper_bound
	.byte	0	 ;  end of children of DIE 0x3d9
	.uleb128 0x2	 ;  (DIE (0x3e9) DW_TAG_base_type)
	.byte	0x2	 ;  DW_AT_byte_size
	.byte	0x7	 ;  DW_AT_encoding
	.long	.LASF2068	 ;  DW_AT_name: "sizetype"
	.uleb128 0x1c	 ;  (DIE (0x3f0) DW_TAG_variable)
	.long	.LASF2069	 ;  DW_AT_name: "spi_in_buf"
	.byte	0x1	 ;  DW_AT_decl_file (../mcu/spi.c)
	.byte	0x24	 ;  DW_AT_decl_line
	...
	.byte	0x3	 ;  DW_OP_addr
	.long	spi_in_buf
	.uleb128 0x1c	 ;  (DIE (0x402) DW_TAG_variable)
	.long	.LASF2070	 ;  DW_AT_name: "spi_out_buf"
	.byte	0x1	 ;  DW_AT_decl_file (../mcu/spi.c)
	.byte	0x24	 ;  DW_AT_decl_line
	.long	0x3d9	 ;  DW_AT_type
	.byte	0x1	 ;  DW_AT_external
	...
	.byte	0x3	 ;  DW_OP_addr
	.long	spi_out_buf
	.uleb128 0x1c	 ;  (DIE (0x414) DW_TAG_variable)
	...
	.byte	0x3	 ;  DW_OP_addr
	.long	spi_in_fifo
	.uleb128 0x1c	 ;  (DIE (0x426) DW_TAG_variable)
	...
	.byte	0x3	 ;  DW_OP_addr
	.long	spi_out_fifo
	.uleb128 0x1c	 ;  (DIE (0x438) DW_TAG_variable)
	...
	.byte	0x3	 ;  DW_OP_addr
	.long	spi_signal
	.uleb128 0x1c	 ;  (DIE (0x44a) DW_TAG_variable)
	...
	.byte	0x3	 ;  DW_OP_addr
	.long	spi_in_data
	.uleb128 0x1d	 ;  (DIE (0x45c) DW_TAG_subprogram)
	.byte	0x1	 ;  DW_AT_external
	...
	.byte	0x1	 ;  DW_AT_prototyped
	.byte	0x1	 ;  DW_AT_declaration
	.long	0x47a	 ;  DW_AT_sibling
	.uleb128 0x1e	 ;  (DIE (0x46a) DW_TAG_formal_parameter)
	.long	0x47a	 ;  DW_AT_type
	.uleb128 0x1e	 ;  (DIE (0x46f) DW_TAG_formal_parameter)
	.long	0x143	 ;  DW_AT_type
	.uleb128 0x1e	 ;  (DIE (0x474) DW_TAG_formal_parameter)
	.long	0x480	 ;  DW_AT_type
	.byte	0	 ;  end of children of DIE 0x45c
	.uleb128 0xd	 ;  (DIE (0x47a) DW_TAG_pointer_type)
	.byte	0x2	 ;  DW_AT_byte_size
	.long	0x216	 ;  DW_AT_type
	.uleb128 0x1f	 ;  (DIE (0x480) DW_TAG_const_type)
	.long	0x30	 ;  DW_AT_type
...
.LLST7:
	...
	.long	.LVL21-.Ltext0	 ;  Location list end address (*.LLST7)
	.word	0x1	 ;  Location expression size
	.byte	0x68	 ;  DW_OP_reg24
	.long	.LVL21-.Ltext0	 ;  Location list begin address (*.LLST7)
	.long	.LVL22-.Ltext0	 ;  Location list end address (*.LLST7)
	.word	0x3	 ;  Location expression size
	.byte	0x88	 ;  DW_OP_breg24
	.sleb128 -1
	.byte	0x9f	 ;  DW_OP_stack_value
...
.LLST8:
	.long	.LVL22-.Ltext0	 ;  Location list begin address (*.LLST8)
	.long	.LVL23-.Ltext0	 ;  Location list end address (*.LLST8)
	.word	0x1	 ;  Location expression size
	.byte	0x68	 ;  DW_OP_reg24
	.long	.LVL23-.Ltext0	 ;  Location list begin address (*.LLST8)
	.long	.LVL24-.Ltext0	 ;  Location list end address (*.LLST8)
	.word	0x3	 ;  Location expression size
	.byte	0x88	 ;  DW_OP_breg24
	.sleb128 1
	.byte	0x9f	 ;  DW_OP_stack_value
	.long	.LVL24-.Ltext0	 ;  Location list begin address (*.LLST8)
	.long	.LVL25-.Ltext0	 ;  Location list end address (*.LLST8)
	.word	0x1	 ;  Location expression size
	.byte	0x68	 ;  DW_OP_reg24
